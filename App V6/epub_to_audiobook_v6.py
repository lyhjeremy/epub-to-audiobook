...
# Print UTF-8 regardless of the console's default codepage (Windows defaults to
# cp1252, which can't encode characters like "→" in --help / progress output).
...
def main():
    ...
    if args.m4b and ordered_paths:
        if not eng.have_ffmpeg():
            print("\n[!] --m4b needs ffmpeg (skipped).\n" + eng.ffmpeg_install_hint())
        else:
