"""
epub_to_audiobook_gui_v5.py — EPUB → MP3 Audiobook Converter (GUI, V5)
======================================================================
...
auto-advance, resume, sleep timer, shortcuts. Built on `audiobook_engine_v5`.
